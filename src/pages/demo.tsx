...
const DemoPage: NextPage = () => {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <section>
        <h2 className="font-bold underline decoration-2">
          Here is the fibonacci of {n}
        </h2>
        ...
        <p>
          ...
          <input
            type="number"
            value={n}
            onChange={(ele) => setN(ele.target.valueAsNumber)}
          ></input>{" "}
          is {fibo.data}
        </p>
      </section>
...
const PetList: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <h1 className="mb-8 text-3xl font-bold">Pets</h1>
      <table className="table-auto border-collapse border border-gray-400">
        ...
        <tbody>
          {pets.data?.map((pet) => (
            <tr key={pet.id} className="bg-gray-200">
