  ...
  return (
    <>
      ...
      <div id="" className=" flex flex-col items-center">
        <div>
          <h1 className="mt-20 text-[50px] font-extrabold text-[#173554]">
            Help Center
          </h1>
...
const HelpMenuCard: FunctionComponent<HelpMenuCardProps> = ({
  ...
  return (
    <Link
      className="flex h-[312px] w-[434px] flex-col rounded-lg pt-4 pr-4 pl-6 text-white duration-100 hover:shadow-lg hover:shadow-slate-400"
      style={{ background: bgColor }}
      href={linkURL}
    >
      <div id="" className="flex justify-end">
        <Image src={iconUrl} width={45} height={45} alt={iconUrl}></Image>
      </div>

      <div id="" className=" mt-8 text-[36px] font-medium drop-shadow-lg">
        <p>{headerText}</p>
      </div>

      <div id="" className=" mt-2 flex flex-col gap-2 text-[12px] font-light">
